...
import { FaHeadset, FaPhone, FaStore, FaShoppingBag } from "react-icons/fa";

import { fetchCategories } from "../APIController";
import { GlobalContext } from "../globalContext";

const Header = () => {
  const [categories, setCategories] = useState([]);

  const { setSelectedCat } = useContext(GlobalContext);
    ...
    <header className="bg-white">
      ...
      >
        ...
        >
          ...
          <a href="#" className="text-base/6 font-semibold text-gray-600">
